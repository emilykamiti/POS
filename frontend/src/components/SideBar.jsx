...
const Sidebar = ({
  ...
  return (
    <nav>
      {isSidebarOpen && (
        <div
          className={`fixed top-0 left-0 h-full bg-gray-800 text-gray-200 box-border transition-all duration-300 ${
              ...
              <div className="flex items-center justify-between p-4 pl-6">
                ...
                {!isNonMobile && (
                  <button
                    ...
                    className="text-gray-200 hover:bg-gray-700 p-1 rounded-full"
                  >
                ...
                {navItems.map(({ text, icon }) => {
                  if (!icon) {
                    return (
                      <div
                        key={text}
                        className="ml-6 my-2 text-gray-400 text-sm font-semibold"
                      >
                        {text}
                      </div>
                    );
