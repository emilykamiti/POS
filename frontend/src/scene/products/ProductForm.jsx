        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded ${mode === 'dark' ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300'}`}
              required
            />
          </div>

          {/* Add other form fields similarly for price, status, stock, etc. */}

          <div className="flex justify-end space-x-4 mt-6">
            <button
              type="button"
              onClick={onClose}
              className={`px-4 py-2 rounded ${mode === 'dark' ? 'bg-gray-600 text-white' : 'bg-gray-200 text-gray-800'}`}
            >
              Cancel
            </button>
            <button
